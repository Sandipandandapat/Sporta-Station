...
public class RegistrationController {
    ...
    //fetch list of teams based on game name

//    @GetMapping("/team/game/{gameName}")
//    public ResponseEntity<?> viewTeamsByGameName(@PathVariable String gameName) throws DataNotFoundException {
//        return new ResponseEntity<>(teamService.viewTeamByTeamId(id),HttpStatus.OK);
//    }
    //                       GAME ENDPOINTS
